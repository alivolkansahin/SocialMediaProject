...
public abstract class ErrorStaticMessage {
    public static final String BLANK_TOKEN = "Token must not be blank!";
    public static final String BLANK_HEADER = "Header must not be blank!";
    public static final String BLANK_CONTENT = "Content must not be blank!";
