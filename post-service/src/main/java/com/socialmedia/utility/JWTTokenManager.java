...
import com.socialmedia.exception.PostManagerException;
...
//        if (decodedJWT == null) throw new AuthManagerException(ErrorType.INVALID_TOKEN);
    ...
    public Optional<String> getRoleFromToken(String token){
        ...
        if (decodedJWT == null) throw new PostManagerException(ErrorType.INVALID_TOKEN);
